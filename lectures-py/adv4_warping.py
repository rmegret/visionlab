...
# - http://scikit-
# image.org/docs/stable/api/skimage.transform.html#skimage.transform.warp
# - http://scikit-image.org/docs/stable/api/skimage.transform.html#skimage.trans
# form.AffineTransform (and other similar classes)
...
# <markdowncell>
# <span style="font-size: 150%;">**Exercise:** Write an algorithm from scratch
# that will
...
# 
# Also see [bilinear interpolation on
...
# - **clock_deblur.py**
# 
#     I took a picture of a wall clock while moving the camera.  Or perhaps the
# clock moved.
...
# the image so that the tiles are displayed as if you were viewing them from
# above?
# 
# The centre-points of the corner circles are, given as (row, column)
# coordinates:
# 
# ```
# (72, 129) -- top left
...
# $\mathbf{x}'$ is the *homogeneous* coordinate in the rectified image (with
# *homogeneous*
# we simply mean that we add an extra 1 at the end, e.g. (72, 129) becomes (72,
# 129, 1).
...
# 
# Why do we need homogeneous coordinates?  It allows us to have *translation* as
# part of H:
# 
# $
...
# $
# 
# Note that each element of the output coordinate is of the form $ax + by + c$.
# Without the 1 in the last position of the coordinate, there would have been no
# $+ c$ and therefore no translation!
# 
# The question on how to determine $H$ is left for another day.  If you are
# curious,
...
# <markdowncell>
# Using the code in the cell above, you can compute the target coordinate of any
...
# 
# <div>
# The solution to the above problem is provided as
# [solutions/tile_rectify.py](solutions/tile_rectify.py).  Only look at it after
# you've attempted the problem yourself!
# </div>
