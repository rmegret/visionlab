...
# ## Keras
# 
# - It's a very romantic notion to think that we can come up with the best
# features
...
# - **At SciPy2017:** "Fully Convolutional Networks for Image Segmentation",
# Daniil Pakhomov, SciPy2017 (Friday 2:30pm)
#   - Particularly interesting, because such networks can be applied to images
# of any size
...
# <markdowncell>
# [Joblib](https://pythonhosted.org/joblib/) (developed by scikit-learn) is used
# for:
# 
# 
...
# <markdowncell>
# [Dask](https://dask.pydata.org) is a parallel computing library.  It has two
# components:
# 
...
# extend common interfaces like NumPy, Pandas, or Python iterators to larger-
# than-memory or distributed environments. These parallel collections run on top
# of the dynamic task schedulers.
# - See Matt Rocklin's
# [blogpost](http://matthewrocklin.com/blog/work/2017/01/17/dask-images) for a
