...
# <markdowncell>
# **Note:** This example has been significantly expanded and enhanced. The new,
# recommended version is located [here](solutions/adv3_panorama-stitching-
# solution.ipynb). We retain this version intact as it was the exact example
# used in [the scikit-image paper](https://peerj.com/articles/453/).
...
# 
# [1]     P. Burt and E. Adelson. ["A Multiresolution Spline With Application to
# Image
# Mosaics"](http://citeseerx.ist.psu.edu/viewdoc/summary?doi=10.1.1.56.690). ACM
# Transactions on Graphics, Vol. 2, No. 4, October 1983. Pg. 217-236.
# [2]     P. Burt and E. Adelson. ["The Laplacian Pyramid as a Compact Image
# Code"](http://dx.doi.org/10.1109/TCOM.1983.1095851). IEEE Transactions on
